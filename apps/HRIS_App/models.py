...
class Employee(AbstractBaseUser, PermissionsMixin):
    ...
    successor = models.CharField(max_length=100, blank=True, null=True, default=None)
    ...
    date_of_last_promotion = models.CharField(max_length=100, blank=True, null=True)
