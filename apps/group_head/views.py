from apps.HRIS_App.models import Employee, Region
...
from apps.HRIS_App.calculate_remaining_grades import calculate_remaining_grades
from django.core.paginator import Paginator
from django.http import JsonResponse
from apps.HRIS_App.models import (
    Designation, 
    Employee, 
    EmployeeType, 
    Cadre, 
